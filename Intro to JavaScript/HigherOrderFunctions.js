...
console.log(retailCompanies);
 ...
 // Get 80s companies
const theEighties = companies.filter((start, end) => start.start < 1990 && end.end < 1990); 
console.log(theEighties);

 // Get companies that lasted 10 years or more
const longerThanTen = companies.filter((s, e) => (e.end - s.start) >= 10);
console.log(longerThanTen);
